...
import QuizDifficulty from './DifficultySelect';
...
export default function Quiz() {
    ...
    //Handles Creating the Quiz based on the User Selections of Quiz Q Count, Diffculty, and Category using the API
    const getQuiz = () => {
        if (playerName) {
            axios.get(
    ...
    return (
        <div className='quiz-main'>
            ...
            <Button
            //Button to Generate Quiz for User
                onClick={getQuiz}
                variant="contained"
