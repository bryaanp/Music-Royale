...
export default function ToolBar({ colorStatus }) {
    ...
    return ( <
        View style = {
            [styles.footnote, styles.infoBoxWrapper, { backgroundColor: 10, }] } >
        ...
        <
        Text style = {
            { color: colorStatus[0] ? 'gray' : 'blue', fontSize: 12 } } >
        <
        FontAwesome5Icon name = 'home'
        size = { 30 }
        color = { colorStatus[0] ? 'gray' : 'blue' }
        /> { '\n' }
        Home <
        /Text> <
        /TouchableOpacity>
        ...
        <
        Text style = {
            { color: colorStatus[1] ? 'gray' : 'blue', fontSize: 12 } } >
        <
        Feather name = 'message-square'
        size = { 30 }
        color = { colorStatus[1] ? 'gray' : 'blue' }
        /> { '\n' }
        Friends <
        /Text> <
        /TouchableOpacity>
        ...
        <
        Text style = {
            { color: colorStatus[2] ? 'gray' : 'blue', fontSize: 12 } } >
        <
        Feather name = 'file-plus'
        size = { 30 }
        color = { colorStatus[2] ? 'gray' : 'blue' }
        /> { '\n' }
        nominee <
        /Text> <
        /TouchableOpacity> <
